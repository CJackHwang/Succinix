...
4. 嵌入应用时按 [SDK.md](SDK.md) 安装 `@succinix/engine` 并挂载到 WebContainer。
...
需要逐字段的服务行为或协议兼容信息时，读取 [SDK.md](SDK.md)、[PROTOCOL.md](PROTOCOL.md) 和 [cordis-contract.md](cordis-contract.md)。
